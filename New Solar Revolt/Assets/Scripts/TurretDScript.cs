...
public class TurretDScript : MonoBehaviour
{
    ...
    public GameObject pfBulletD;
    public Transform spawnLocationBulletD;
    ...
    {
        GameObject bullet = Instantiate(pfBulletD, spawnLocationBulletD.position, spawnLocationBulletD.rotation);
        bullet.GetComponent<BulletDScript>().SetTarget(target.gameObject);   
    }
